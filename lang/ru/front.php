...
return [
    ...
    'age_gate' => [
        ...
        'brand' => 'ZasukejSi.cz',
        'body' => ', включая все веб-страницы, ссылки и изображения, содержит материалы сексуального характера. За пределами этой страницы доступ разрешён только совершеннолетним. Если вы несовершеннолетний (младше 18 лет или 21 года там, где 18 лет не является возрастом совершеннолетия), если материалы сексуального характера вас оскорбляют или если просмотр таких материалов в вашей стране незаконен, вы ОБЯЗАНЫ покинуть сайт, нажав кнопку «ВЫЙТИ» ниже. Нажимая «ВОЙТИ», вы соглашаетесь с заявлением внизу этой страницы. ZasukejSi.cz придерживается политики нулевой терпимости к детской порнографии и к несовершеннолетним, размещающим объявления или пользующимся нашим сайтом. Я обязуюсь сообщать о любых незаконных услугах или действиях, нарушающих условия использования. Я также обязуюсь сообщать в соответствующие органы о подозрениях на насилие над несовершеннолетними и/или торговлю людьми.',
        'agreement' => 'Вы прочитали это соглашение, поняли его и согласны его соблюдать.',
        'enter' => 'Войти',
        'leave' => 'Выйти',
    ],
    ...
    'payments' => [
        'choose_method' => 'Способ оплаты',
        'awaiting_transfer' => 'Ждём вашу оплату',
        'awaiting_transfer_hint' => 'Заказ создан. Как только деньги придут, мы активируем подписку — срок начнётся с этого момента, а не со дня заказа.',
        'transfer_created' => 'Заказ создан. Реквизиты для оплаты ниже.',
