...
@section('member-content')
    ...
    <form method="POST" action="{{ route('account.member.password.update') }}" class="space-y-8">
        @csrf
        @method('PATCH')
        ...
        <div class="flex justify-end space-x-4">
            <a href="{{ route('account.member.dashboard') }}" class="btn-secondary btn-small justify-center">
