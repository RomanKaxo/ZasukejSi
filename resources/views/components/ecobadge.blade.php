<div {{ $attributes->merge(['class' => 'inline-flex w-full max-w-[309px] items-center gap-3 rounded-[12px] bg-[#E6FEE8] px-[18px] py-[14px] lg:max-w-[1140px] lg:h-[35px] lg:py-0 lg:justify-center']) }}>
