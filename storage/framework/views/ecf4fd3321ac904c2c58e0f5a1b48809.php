...
<?php $__env->startSection('content'); ?>
    <?php if($page->type === 'blog'): ?>
        <div class="w-full mt-20">
            <div class="mb-8 sm:rounded-lg overflow-hidden relative">
                <?php if($page->hasMedia('header-image')): ?>
                    <img src="<?php echo e($page->getFirstMediaUrl('header-image')); ?>" alt="<?php echo e($page->title); ?>"
                ...
                <div class="absolute bottom-4 left-4 flex gap-2">
                    <time datetime="<?php echo e($page->created_at->format('Y-m-d')); ?>" 
                        ...
                        <?php echo e($page->created_at->translatedFormat(__('blogs.date_format'))); ?>

                    </time>
                    
                    <?php if($page->aproximateReadingTime() > 0): ?>
                        <div class="inline-flex items-center px-4 py-3 bg-white backdrop-blur-sm text-gray-700 rounded-full text-sm font-medium shadow-lg">
                            ...
                            <?php echo e($page->aproximateReadingTime()); ?> <?php echo e(__('blogs.min_read')); ?>
    ...
    <div class="max-w-7xl mx-auto px-4 py-8 <?php echo e($page->type === 'blog' ? 'pt-8' : 'pt-28'); ?>">
        <!-- Page Heading -->
        ...
        <div class="max-w-none">
            ...
            ?>
            <?php echo SkyRaptor\FilamentBlocksBuilder\BlocksRenderer::render($content); ?>
        </div>
    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\roman\Desktop\ZasukejSi\resources\views/pages/show.blade.php ENDPATH**/ ?>