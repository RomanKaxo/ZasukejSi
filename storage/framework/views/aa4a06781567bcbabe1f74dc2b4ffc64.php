    ...
    <div x-show="show"
        ...
        <div class="modal-container">
            ...
            <div class="modal-header">
                <h1 class="modal-title"><?php echo e(__('auth.reset.subtitle')); ?></h1>
                <p class="modal-description"><?php echo e(__('auth.reset.description')); ?></p>
            </div>

            <!-- Form -->
            <form wire:submit="sendResetLink" class="form-container">
                <!-- Reset Error -->
                <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['reset'];
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                ...
                <!-- Email Field -->
                <div>
                    <label class="form-label"><?php echo e(__('auth.reset.email_label')); ?></label>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                ...
                <button type="submit"
                    ...
                    <span wire:loading.remove wire:target="sendResetLink"><?php echo e(__('auth.reset.send_button')); ?></span>
                    <span wire:loading wire:target="sendResetLink"><?php echo e(__('auth.reset.sending')); ?></span>
                </button>
            </form>
            ...
            <div class="text-center">
                ...
                <!-- Success Message -->
                <h1 class="text-xl sm:text-2xl md:text-3xl font-bold text-secondary mb-2 sm:mb-3 md:mb-4"><?php echo e(__('auth.reset.success_title')); ?></h1>
                <p class="text-gray-600 mb-4 sm:mb-6 md:mb-8 text-xs sm:text-sm md:text-base lg:text-lg leading-relaxed"><?php echo e(__('auth.reset.success_message')); ?></p>
                ...
                <div class="space-y-2 sm:space-y-2.5 md:space-y-3">
                    <button type="button"
                        ...
                        x-bind:disabled="closing"
                        class="modal-btn-primary">
                        <?php echo e(__('auth.reset.back_to_login')); ?>
                    ...
                    <button type="button"
                        ...
                        <?php echo e(__('auth.reset.close')); ?>
...
</div><?php /**PATH C:\Users\roman\Desktop\ZasukejSi\resources\views/livewire/reset-modal.blade.php ENDPATH**/ ?>